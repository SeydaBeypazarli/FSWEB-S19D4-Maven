...
public class Converter {
    ...
    public static ActorResponse actorCreatedResponseConvert(Actor savedActor) {
        return  new ActorResponse(savedActor.getId(),
                savedActor.getFirstName(), savedActor.getLastName(),
